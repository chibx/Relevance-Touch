...
<template>
    <div>
        ...
        >
            ...
            <!-- Hero Content -->
            <div
                class="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8"
            >
                <h1
                    class="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 text-balance"
                >
                    Where <span class="text-accent">Creativity</span> Meets
                    Excellence
                </h1>
                <p
                    class="text-xl md:text-2xl mb-8 text-pretty max-w-3xl mx-auto opacity-90"
                >
                    Professional creative studio showcasing world-class artists,
                    bands, and multimedia productions
                </p>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    ...
                    <p class="text-xl max-w-2xl mx-auto">
                        Discover the talented individuals who bring our creative
                        vision to life
                    </p>
                </div>
        ...
        <section class="py-20 bg-muted">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    ...
                    <p class="text-xl max-w-2xl mx-auto">
                        Collaborative groups creating powerful musical
                        experiences
                    </p>
                </div>
        ...
        <section class="py-20">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    ...
                    <p class="text-xl max-w-2xl mx-auto">
                        Explore our recent video productions and photography
                    </p>
                </div>
                ...
                >
                    ...
                    >
                        <div
                            class="relative overflow-hidden rounded-xl aspect-video bg-card"
                        >
                            <img
                                :src="work.thumbnail"
                                :alt="work.title"
        ...
        <section class="py-20">
            <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                ...
                <p class="text-xl mb-8">
                    Join our community of talented artists and bring your
