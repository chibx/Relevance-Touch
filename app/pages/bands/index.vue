        ...
        <section class="bg-muted py-20">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <p class="text-xl max-w-3xl mx-auto">
                    Discover the collaborative groups and ensembles that create
                    powerful musical experiences. Each band brings together
                    talented musicians to create something greater than the sum
                    of its parts.
                </p>
            </div>
        </section>
