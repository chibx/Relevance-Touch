...
<template>
    <div class="min-h-screen">
        ...
        <section class="bg-muted py-20">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <p class="text-xl max-w-3xl mx-auto">
                    Discover the collaborative groups and ensembles that create powerful musical experiences. Each band
                    brings together talented musicians to create something greater than the sum of its parts.
                </p>
            </div>
        </section>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-wrap gap-5 justify-center">
                    <button
                        ...
                        :class="[
                            'px-6 py-2.5 cursor-pointer rounded-full font-medium transition-colors duration-200',
                            selectedBand === 'all' ? 'bg-black text-white' : '',
                        ]"
                    >
                        All Bands
                    </button>
                    <button
                        ...
                        :key="genre"
                        @click="selectedBand = genre"
                        :class="[
                            'px-6 py-2 cursor-pointer rounded-full font-medium transition-colors duration-200',
                            selectedBand === genre ? 'bg-black text-white' : '',
                        ]"
                    >
                        {{ genre }}
                    </button>
        ...
        <section class="py-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div ref="parent" class="flex flex-wrap gap-8 justify-center place-content-center">
                    <!-- class="band-box grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center place-content-center" -->
