...
const links = Object.fromEntries(
    Object.entries(props.socials).filter(([key]) => !!props.socials[key as keyof Socials]),
);
</script>

<template>
    <div class="flex space-x-3">
        <a v-for="(links, val) in socials" :href="links">
            <img :src="socialsToIcon(val)" width="35" height="35" class="w-[50px] h-[50px] lg:w-[35px] lg:h-[35px]" />
            <!-- <svg
            class="w-5 h-5"
            fill="currentColor"
            viewBox="0 0 24 24"
